...
function buscar_reportes_areas(){
    ...
    if(area==""){
     ...
     fetch(`http://localhost:1339/api/Reporte/reportes_area/responsable/${area}`,{
        method:'GET',
        body:JSON.stringify(),
        headers:{
            'Content-Type':'application/json'
...
function buscar_reportes(){
    ...
    if(id_empleado==""){
        ...
        lista.innerHTML="";
            ...
            fetch( `http://localhost:1339/api/Reporte/Empleados_report/${id_empleado}`,{
                method:'GET',
                body:JSON.stringify(),
                headers:{
                    'Content-Type':'application/json'
...
function Empleado_asignado(id_reporte,definitiva){
    ...
    if(estado=="" || empleado=="" || comentarios ==""){
        ...
        fetch('http://localhost:1339/api/Reporte/Cierre_reportes/final',{
            method:'PUT',
